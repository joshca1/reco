	...
	function uf_convertir_srhcontratos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("srh_contratos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_srhmovimientopersonal()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_nrocon);
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("srh_movimientopersonal",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_srhsolicitudadiestramientos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","cosadi");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("srh_solicitudadiestramientos",$la_seguridad);
			}
		}		
		return $lb_valido;
