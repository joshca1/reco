...
class sigesp_rcm_c_sep
{
	...
	function uf_convertir_sepconceptos()
	{
		...
		$ls_sql=" SELECT codconsep, monconsepe ".
				" FROM   sep_conceptos where monconsepe!=0 ";
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monconsepe");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_conceptos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepcuentagasto()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_cuentagasto",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepdtarticulos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monart");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_dt_articulos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepdtconcepto()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_dt_concepto",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepdtservicio()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monser");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_dt_servicio",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepdtacargos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_dta_cargos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepdtccargos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_dtc_cargos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepdtscargos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_dts_cargos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepsolicitud()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monbasinm");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_monbasinm);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","montotcar");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_solicitud",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sepsolicitudcargos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sep_solicitudcargos",$la_seguridad);
			}
		}		
		return $lb_valido;
