	...
	function uf_convertir_rpcproveedor()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				// Campos a Convertir
				$this->io_rcbsf->io_ds_datos->insertRow("campo","capital");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_capital);
				
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monmax");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("rpc_proveedor",$la_seguridad);
			}
		}		
		return $lb_valido;
