...
class sigesp_rcm_c_siv
{
	...
	function uf_convertir_sivarticulo()
	{
		...
		$ls_sql=" SELECT codemp, codart, prearta, preartb, ".
				...
				" FROM   siv_articulo   ".
				" WHERE  codemp='".$this->ls_codemp."'  and (preartc!=0 or preartd!=0 or ultcosart!=0 or cosproart!=0)";
				// echo $ls_sql;
				// exit();
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","prearta");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_prearta);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preartb");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_preartb);
				
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preartc");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_preartc);

				$this->io_rcbsf->io_ds_datos->insertRow("campo","preartd");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_preartd);

				$this->io_rcbsf->io_ds_datos->insertRow("campo","ultcosart");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_ultcosart);
				
				$this->io_rcbsf->io_ds_datos->insertRow("campo","cosproart");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("siv_articulo",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sivdtdespacho()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("siv_dt_despacho",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sivdtmovimiento()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","cosart");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("siv_dt_movimiento",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sivdtrecepcion()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("siv_dt_recepcion",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sivdtscg()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("siv_dt_scg",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sivdttransferencia()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","cosuni");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_cosuni);
				
				$this->io_rcbsf->io_ds_datos->insertRow("campo","costot");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("siv_dt_transferencia",$la_seguridad);
			}
		}		
		return $lb_valido;
