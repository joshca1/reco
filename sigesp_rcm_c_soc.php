...
class sigesp_rcm_c_soc
{
	...
	{	
		...
		// if($lb_valido) NO EXISTE ESTA TABLA EN ENTERPRISE
		// {	
	...
	function uf_convertir_soccotizacion()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monsubtot");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_monsubtot);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monimpcot");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_monimpcot);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","mondes");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_mondes);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","montotcot");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_cotizacion",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_soccuentagasto()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_cuentagasto",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socdtbienes()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preuniart");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_preuniart);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monsubart");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_monsubart);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","montotart");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_dt_bienes",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socdtcomac()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preproa");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_preproa);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preprob");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_preprob);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preproc");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_preproc);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preprod");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_dt_com_ac",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socdtservicio()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monuniser");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_monuniser);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monsubser");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_monsubser);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","montotser");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_dt_servicio",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socdtacargos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_dta_cargos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socdtcotbienes()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","moniva");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_codart);
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_dtcot_bienes",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socdtcotservicio()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_codser);
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_dtcot_servicio",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socdtscargos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_codcar);
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_dts_cargos",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sococdeducciones()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_oc_deducciones",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socordencompra()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monsegcom");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_monsegcom);

				$this->io_rcbsf->io_ds_datos->insertRow("campo","monsubtotbie");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$li_monsubtotbie);

				$this->io_rcbsf->io_ds_datos->insertRow("campo","monsubtotser");
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","montotdiv");
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","tascamordcom");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_estcondat);
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_ordencompra",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socservicios()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preser");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_codser);
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_servicios",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_socsolicitudcargos()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_codcar);
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("soc_solicitudcargos",$la_seguridad);
			}
		}		
		return $lb_valido;
