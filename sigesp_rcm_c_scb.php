	...
	function uf_convertir_scbcolocacion()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monint");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_colocacion",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scbconciliacion()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","salseglib");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_salseglib);

				$this->io_rcbsf->io_ds_datos->insertRow("campo","salsegbco");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_salsegbco);
				
				$this->io_rcbsf->io_ds_datos->insertRow("campo","conciliacion");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_conciliacion",$la_seguridad);
			}
		}		
		return $lb_valido;
	}// end function uf_convertir_scbcolocacion
	...
	function uf_convertir_scbdtcmpret()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","totimp");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_totimp);
				
				$this->io_rcbsf->io_ds_datos->insertRow("campo","iva_ret");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_dt_cmp_ret",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_dt_cmp_ret_op()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_dt_cmp_ret_op",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_dt_movbco()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monsolpag");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_dt_movbco",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_errorconcbco()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monmov");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_errorconcbco",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movbco()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movbco",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movbco_scg()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movbco_scg",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movbco_spg()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movbco_spg",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movbco_spgop()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movbco_spgop",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movbco_spi()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movbco_spi",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movcaja()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","mone");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_mone);

				$this->io_rcbsf->io_ds_datos->insertRow("campo","monc");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movcaja",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movcol()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monmovcol");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movcol",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movcol_scg()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movcol_scg",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movcol_spg()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movcol_spg",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_scb_movcol_spi()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("scb_movcol_spi",$la_seguridad);
			}
		}		
		return $lb_valido;
