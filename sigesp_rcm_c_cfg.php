	...
	function uf_convertir_sigespcmp()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sigesp_cmp",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sigespcmpmd()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sigesp_cmp_md",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sigespdeducciones()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monded");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sigesp_deducciones",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sigespempresa()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","salinipro");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_salinipro);
	
	  		    $this->io_rcbsf->io_ds_datos->insertRow("campo","salinieje");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sigesp_empresa",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_sigespmoneda()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","tascam");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("sigesp_moneda",$la_seguridad);
			}
		}		
		return $lb_valido;
