	...
	function uf_convertir_safactivo()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","costo");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_costo);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","cossal");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_cossal);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monordcom");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_monordcom);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","moncobase");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("saf_activo",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_safcontable()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("saf_contable",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_safdepreciacion()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","mondepmen");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_mondepmen);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","mondepano");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ld_mondepano);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","mondepacu");
				...
				$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("saf_depreciacion",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_safdtmovimiento()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("campo","monact");
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("saf_dt_movimiento",$la_seguridad);
			}
		}		
		return $lb_valido;
	...
	function uf_convertir_safpartes()
	{
		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$lb_valido=$this->io_rcbsf->uf_reconvertir_datos("saf_partes",$la_seguridad);
			}
		}		
		return $lb_valido;
